...
const Products: React.FC = () => {
  ...
  return (
    <div className="bg-white">
      ...
      <title>Industrial & Cryogenic Gas Manufacturer in India | Oxygen, Nitrogen, Argon, CO₂</title>
      <meta
        name="description"
        content="Shakti Industrial Gases is a leading Indian manufacturer of industrial and cryogenic gases including Oxygen, Nitrogen, Argon and CO₂. Bulk tanker and cylinder supply across India."
      />
      ...
      <section id="portfolio" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-12">
          Industrial, Cryogenic & Specialty Gas Product Portfolio
        </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Bulk, Cylinder & Pipeline Gas Supply Options
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Scalable supply solutions including cryogenic tankers, on-site storage and cylinder distribution to meet diverse industrial demands.
            </p>
          </div>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-20 text-center">
            Industrial Gases Serving Core Manufacturing Sectors
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 text-center">
            {INDUSTRIES.map((industry, index) => (
              <div key={index} className="flex flex-col items-center group cursor-pointer">
                ...
                <h3 className="text-sm font-bold text-gray-900 max-w-[140px] leading-tight group-hover:text-shakti-blue transition-colors">
                  {industry.name}
                </h3>
              </div>
            ))}
