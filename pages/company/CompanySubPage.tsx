      ...
      <div className="bg-slate-950 text-white py-12 sm:py-16 border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <NavLink
              to="/contact"
              className="inline-flex items-center justify-center gap-2 bg-sky-600 hover:bg-sky-700 text-white text-xs font-semibold px-5 py-2.5 rounded-lg transition shrink-0 shadow-sm"
            >
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4">
                {data.entitiesOrFacilities.map((item, idx) => (
                  <div key={idx} className="bg-white p-5 rounded-lg border border-slate-200 space-y-3">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      <h4 className="text-sm sm:text-base font-bold text-slate-900">{item.name}</h4>
                      <span className="bg-slate-100 text-slate-700 font-semibold text-xs px-2.5 py-0.5 rounded border border-slate-200 uppercase">
                        {item.badge}
                      </span>
                    </div>
                    ...
                    {item.specs && item.specs.length > 0 && (
                      <div className="pt-2 border-t border-slate-100 flex flex-wrap gap-2 text-xs">
                        {item.specs.map((sp, sIdx) => (
                          <div key={sIdx} className="bg-slate-50 px-2 py-1 rounded border border-slate-200 text-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {data.processSteps.map((stepItem, idx) => (
                  <div key={idx} className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                    <div className="text-xs font-bold text-sky-700 uppercase mb-1">
                      Step {stepItem.step}
                    </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-slate-950 text-white p-6 rounded-lg space-y-4 border border-slate-800">
              ...
              <div className="pt-2">
                <NavLink
                  to="/contact"
                  className="block text-center w-full bg-sky-600 hover:bg-sky-700 text-white font-medium py-2.5 rounded-lg text-xs transition"
                >
