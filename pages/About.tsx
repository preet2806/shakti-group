              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
                  ...
                  <div className="relative h-full min-h-[400px]">
                     <img src="https://qe2eq2zzuxmkvacf.public.blob.vercel-storage.com/about_legacy.png" className="w-full h-full object-cover rounded-2xl shadow-2xl" alt="Factory History" />
