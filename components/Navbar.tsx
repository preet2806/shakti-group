...
import { Menu, X, ChevronDown, ArrowRight, Phone, Mail, FileText, ShieldCheck, Linkedin } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-5">
            ...
            <a
              ...
              className="flex items-center gap-1.5 text-slate-300 hover:text-sky-400 transition font-medium"
              title="Shakti Industrial Gases on LinkedIn"
            >
          ...
          <div className="lg:hidden absolute top-full left-0 right-0 w-full bg-white border-b border-slate-200 shadow-2xl z-50 max-h-[calc(100dvh-4rem)] sm:max-h-[calc(100dvh-7rem)] overflow-y-auto overscroll-contain">
            <div className="p-4 space-y-3">
              ...
              <div className="grid grid-cols-3 gap-2 pb-2 border-b border-slate-100">
                <a
                  href="tel:+919727783440"
                  className="flex items-center justify-center gap-1.5 py-2.5 px-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-semibold text-slate-700 hover:bg-slate-100 transition"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-1.5 py-2.5 px-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-semibold text-slate-700 hover:bg-slate-100 hover:text-sky-700 transition"
                >
                  <Linkedin className="h-3.5 w-3.5 text-sky-600 shrink-0" />
                  <span>LinkedIn</span>
                </a>
              </div>
